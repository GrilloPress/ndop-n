...
function matchDetails() {
	...
	if ((firstName == 'devil') && (formComplete == true)) {
			window.location.href = "/M4" + '/app/02X-verification-fail';
		} else if ((formComplete == true) && (firstName == 'satan')) {
			window.location.href = "/M4" + '/app/02X-contact-us';
		} else if ((formComplete == true) && (firstName == 'young')) {
			window.location.href = "/M4" + '/app/02X-age-restriction';
		} else if (formComplete == true) {
			window.location.href= "/M4" + "/app/03-verification-option"
		}
};

...
function submit() {
  ...
  if (sessionStorage.firstName === "Fake") {
    ...
    window.location.href = "v2-how/errors/05X-verification-fail";

  } else if (sessionStorage.firstName === "Age") {

    window.location.href = "v2-how/errors/05X-age-restriction";

  } else {

    window.location.href = "/v2-how/app/without-nhs-number/05-spinner";
